...
export const translations: Record<Language, Translations> = {
  ...
  genz: {
    profile: 'My Developer Lore',
    projects: 'Stuff I Cooked',
    contact: 'Let\'s Talk',
    skills: 'My Developer Aura',
    info: 'Details fr',
    portfolioTitle: 'KRISHNA\'S PORTFOLIO',

    developerLevel: 'Dev Grind Level',
    yearsOfExperience: 'Years in the Dev Grind',
    repositories: 'Code Dumps',
    followers: 'The Besties',
    totalStars: 'Aura Points (Stars)',
    achievements: 'The Ws Unlocked',
    workStatus: 'Locked In & Looking for Work',
    profileDescription: "Just your average developer from the Pachora — I'm locked in on turning ideas into real, working solutions and love debugging until I beat the final boss. Off the clock, I'm just a chill guy touching grass, vibing, and learning new lore.",

    recentActivity: 'Recent Lore',
    contributions: 'times I cooked in last 12 weeks',
    viewAllActivity: 'See the GitHub Lore',
    featuredProjects: 'Projects That Actually Cook',
    achievementShowcase: 'Massive Ws',
    personalHobbies: 'Side Quests',
    technicalSkills: 'My Dev Toolkit',
    connectWithMe: 'Slide Into My DMs',
    githubFollowers: 'GitHub Besties',

    viewResume: 'Grab My Resume',
    viewAll: 'See More',
    sendMessage: 'Send It 🚀',
    ...
    allTab: 'All',
    unlockedTab: 'Unlocked Ws',
    lockedTab: 'Still Locked',

    footerQuickLinks: 'Quick Lore',
    footerAbout: 'About the Chef',
    footerTagline: 'Steam-inspired portfolio full of massive Ws',
    footerCopyright: '© 2025 Krishna Patil. Built different.',
    footerMadeWith: 'Made with main character energy',

    replayTitle: 'GitHub Replay',
    replayLoading: 'Cooking your stats...',
    replayError: 'Bro, we are cooked 💀 (Failed to load)',
    replayOverviewTitle: 'Your Lore This Year',
    replayOverviewCommits: 'Times You Sent It',
    replayOverviewMostActiveMonth: 'Peak Cooking Month',
    replayOverviewLongestStreak: 'Longest Grindset',
    replayOverviewDaysCoded: 'Days Locked In',
    replayLanguageTitle: 'Tech Arc',
    replayLanguageSubtitle: "Bro is literally a {language} main!",
    replayImpactTitle: 'Aura Points Gained',
    replayImpactStarsEarned: 'Stars Secured',
    replayImpactForks: 'Forks Gained',
    replayImpactReposCreated: 'Repos Shipped',
    replayImpactTopRepo: 'Most Goated Repo',
    replayProductivityTitle: 'Grindset Patterns',
    replayProductivityMostProductiveDay: 'Most Cracked Day',
    replayProductivityPeakHour: 'Peak Cooking Hour',
    replayProductivityNightOwl: 'No Sleep Just Code',
    replayProductivityWeekendWarrior: 'Weekend Side Quests',
    replayCollaborationTitle: 'Multiplayer Arc',
    replayCollaborationPrsCreated: 'PRs Shipped',
    replayCollaborationPrsMerged: 'PRs Accepted (W)',
    replayCollaborationIssuesClosed: 'Bugs Defeated',
    replayCollaborationTopCollabRepo: 'Top Co-op Repo',
    replayGrowthTitle: 'The Character Arc',
    replayGrowthFollowers: 'New Besties',
    replayGrowthTotalRepos: 'Total Projects Cooked',
    replayGrowthContributionGraph: 'The Green Squares of Validation',
    replayGrowthFooter: 'That was your {year} arc. Absolute cinema 🎬'
  }
}
